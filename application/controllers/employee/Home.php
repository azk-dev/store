...
class Home extends Employee_Controller {
	...
	{
		redirect(base_url('employee/product'));
		...
		$table[ "rows" ] = $this->group_model->homes( $pagination['start_record'], $pagination['limit_per_page'] )->result();
