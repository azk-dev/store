...
class Category extends Employee_Controller {
	private $services = null;
    private $name = null;
    private $parent_page = 'employee';
	private $current_page = 'employee/category/';
	...
	public function index()
	{
		...
		$this->data["block_header"] = "Manajemen Kategori";
		$this->data["header"] = "Kategori Produk";
